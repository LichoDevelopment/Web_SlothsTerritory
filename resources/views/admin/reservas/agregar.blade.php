            ...
            <form action="{{ route('reserva.guardar') }}" method="post">
                ...
                <section class="row mb-3">
                    ...
                    <article class="col-6">
                        ...
                        <input type="number" min="0" class="form-control" id="cantidad_adultos"
                            name="cantidad_adultos" required>
                    </article>
                </section>
                <section class="row mb-3">
                    <article class="col-6">
                        <label for="cantidad_niños">Niños</label>
                        <input type="number" min="0" class="form-control" id="cantidad_niños" name="cantidad_niños" value="0"
                            required>
                    </article>
                    <article class="col-6">
                        <label for="cantidad_niños_gratis">Niños gratis</label>
                        <input type="number" min="0" class="form-control" id="cantidad_niños_gratis"
                            name="cantidad_niños_gratis" required value="0">
                    </article>
                </section>
                <section class="row mb-3">
                    <article class="col-6">
                ...
                <section class="row mb-3">
                    ...
                    <article class="col-6">
                        ...
                        <input type="number" step=".01" min="0" value="0" name="descuento" id="descuento"
                            class="form-control" required>
                    </article>
                </section>
                <section class="row mb-3">
